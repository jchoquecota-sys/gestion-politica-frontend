...
export function Sidebar({ className }: SidebarProps) {
  ...
  const routes = [
    ...
    },
    {
      ...
      show: hasPermission('sectores:view'),
    },
    {
      label: 'Bases',
      icon: MapPin,
    ...
    },
    {
      ...
      show: hasPermission('personas:view'),
    },
    {
      label: 'Actividades',
      icon: FileText,
      ...
      show: hasPermission('actividades:view'),
    },
    {
      label: 'Cargos',
      icon: ShieldCheck,
      ...
      show: hasPermission('cargos:view'),
    },
    {
